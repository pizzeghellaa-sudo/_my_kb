...
Copy-paste prompts for every stage of the [[llm-knowledge-base-concept]] workflow. Sourced from [[god-of-prompt]]'s breakdown of [[andrej-karpathy]]'s system.
...
- [[ingest-workflow]] — when to use ingest prompts
- [[query-workflow]] — when to use query prompts
- [[lint-workflow]] — when to use lint prompt
- [[kb-architecture]] — the schema these prompts reference
- [[claude-code-settings]] — natural language prompts for Claude Code configuration
